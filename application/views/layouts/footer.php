    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 footer-links">
        ...
        <ul>
          ...
          <li><i class="bx bx-chevron-right"></i> <a href="#">UKS</a></li>
          <li><i class="bx bx-chevron-right"></i> <a href="#">Ruang Ibadah</a></li>
          <li><i class="bx bx-chevron-right"></i> <a href="#">Ruang Guru</a></li>
